...
#define 			LCD_SCL_CLR 					HAL_GPIO_WritePin(LCD_SCK_SM_GPIO_Port, LCD_SCK_SM_Pin, GPIO_PIN_RESET)
#define 			LCD_SCL_SET 					HAL_GPIO_WritePin(LCD_SCK_SM_GPIO_Port, LCD_SCK_SM_Pin, GPIO_PIN_SET)

#define 			LCD_SDA_CLR 					HAL_GPIO_WritePin(LCD_SDA_SM_GPIO_Port, LCD_SDA_SM_Pin, GPIO_PIN_RESET)
#define 			LCD_SDA_SET 					HAL_GPIO_WritePin(LCD_SDA_SM_GPIO_Port, LCD_SDA_SM_Pin, GPIO_PIN_SET)
...
#define 			LCD_RST_SET 		 			HAL_GPIO_WritePin(LCD_RESET_GPIO_Port, LCD_RESET_Pin, GPIO_PIN_RESET)
#define 			LCD_RST_CLR  					HAL_GPIO_WritePin(LCD_RESET_GPIO_Port, LCD_RESET_Pin, GPIO_PIN_SET)
